...
class Contact():
    def __init__(self, first_name, last_name = None, mobile_num = None, work_num = None, email = None, *args):
...
brad = Contact('Brad', 'Fenworth', 12284001753, 13724456001, 'brad.fenworth@gmail.com')
